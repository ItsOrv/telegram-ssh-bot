...
def get_main_menu_keyboard(is_admin: bool = False) -> InlineKeyboardMarkup:
    ...
    keyboard = [
        [
            InlineKeyboardButton("🖥️ Server Management", callback_data="menu_servers"),
...
def get_server_list_keyboard(servers: List[Dict], action: str = "select") -> InlineKeyboardMarkup:
    ...
    for server in servers:
        ...
        keyboard.append([InlineKeyboardButton(f"🖥️ {server_name}", callback_data=callback_data)])
    
    keyboard.append([InlineKeyboardButton("◀️ Back", callback_data="menu_servers")])
    return InlineKeyboardMarkup(keyboard)
...
def get_server_actions_keyboard(server_id: int) -> InlineKeyboardMarkup:
    ...
    keyboard = [
        [
            InlineKeyboardButton("✏️ Edit", callback_data=f"server_edit_{server_id}"),
            InlineKeyboardButton("🗑️ Delete", callback_data=f"server_delete_{server_id}")
        ],
        [
            InlineKeyboardButton("◀️ Back", callback_data="server_list")
        ]
    ]
    return InlineKeyboardMarkup(keyboard)
...
def get_preset_list_keyboard(presets: List[Dict]) -> InlineKeyboardMarkup:
    ...
    keyboard.append([InlineKeyboardButton("◀️ Back", callback_data="menu_presets")])
    return InlineKeyboardMarkup(keyboard)
